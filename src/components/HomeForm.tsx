...
import {PaperClipIcon, TagIcon, UserCircleIcon} from '@heroicons/react/20/solid'
                            ...
                            <>
                                ...
                                <div className="relative">
                                    <Listbox.Button
                                        ...
                                        {assigned.value === null ? (
                                            <UserCircleIcon className="h-5 w-5 flex-shrink-0 text-gray-300 sm:-ml-1"
                                                            aria-hidden="true"/>
                                        ) : (
                                            <img src={assigned.avatar} alt=""
                ...
                <div className="flex items-center justify-between space-x-3 border-t border-gray-200 px-2 py-2 sm:px-3">
                    <div className="flex">
                        ...
                        >
                            ...
                            <span
                                className="text-sm italic text-gray-500 group-hover:text-gray-600">Attach a file</span>
                        </button>
                    </div>
